  ...
  return _createClass(CleanTalkWidgetDoboard, [{
    ...
    value: function bindCreateTaskEvents() {
      ...
      if (submitButton) {
        submitButton.addEventListener('click', function () {
          ...
          var userName = document.getElementById('doboard_task_widget-user_name').value;
          var userEmail = document.getElementById('doboard_task_widget-user_email').value;
          var typeSend = checkbox && !checkbox.checked ? 'private' : 'public';
          var taskDetails = {
            taskTitle: taskTitle,
    ...
    value: (function () {
      var _createWidgetElement = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee5(type) {
        ...
        var widgetContainer, tasks, issuesQuantityOnPage, i, elTask, taskTitle, taskDescription, currentPageURL, selectedPageURL, taskNodePath, _themeData4, taskSelectedData, taskElement, text, start, end, selectedText, beforeText, afterText;
        return _regeneratorRuntime().wrap(function _callee5$(_context5) {
          while (1) switch (_context5.prev = _context5.next) {
            case 0:
              ...
              tasks = this.getTasks();
              _context5.t0 = type;
              _context5.next = _context5.t0 === 'create_issue' ? 7 : _context5.t0 === 'wrap' ? 10 : _context5.t0 === 'all_issues' ? 13 : 16;
              break;
            case 7:
            ...
            case 19:
              ...
              _context5.t1 = type;
              _context5.next = _context5.t1 === 'create_issue' ? 24 : _context5.t1 === 'wrap' ? 26 : _context5.t1 === 'all_issues' ? 28 : 54;
              break;
            case 24:
    ...
    value: function submitTask(taskDetails) {
      if (taskDetails && taskDetails.taskTitle && taskDetails.taskDescription && taskDetails.userName && taskDetails.userEmail) {
