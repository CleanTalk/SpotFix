...
`;
    ...
    static create_issue() {
        return `
<div class="doboard_task_widget-container" xmlns="http://www.w3.org/1999/html">
    <div class="doboard_task_widget-header">
        <div style="display: flex;align-items: center;gap: 8px;">
            <img src="{{logoDoBoardGreen}}"  alt="">
