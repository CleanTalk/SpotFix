        ...
        if (restorePasswordButton) {
            restorePasswordButton.addEventListener('click', async () => {
                ...
                try {
                    ...
                    this.registrationShowMessage('Password recovery instructions have been sent to your email', 'notice');
                } catch (error) {
