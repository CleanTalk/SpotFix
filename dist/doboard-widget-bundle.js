(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["SpotFix"] = factory();
	else
		root["SpotFix"] = factory();
})(this, () => {
...
/* harmony export */   SPOTFIX_DEBUG: () => (/* binding */ SPOTFIX_DEBUG),
/* harmony export */   SPOTFIX_SELECTION_OPEN_DELAY: () => (/* binding */ SPOTFIX_SELECTION_OPEN_DELAY),
/* harmony export */   SPOTFIX_VERSION: () => (/* binding */ SPOTFIX_VERSION)
/* harmony export */ });
const SPOTFIX_VERSION = "1.1.13";
const SPOTFIX_SELECTION_OPEN_DELAY = 1000;
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   addIconPack: () => (/* binding */ addIconPack),
/* harmony export */   addTaskComment: () => (/* binding */ addTaskComment),
/* harmony export */   changeSize: () => (/* binding */ changeSize),
/* harmony export */   checkLogInOutButtonsVisible: () => (/* binding */ checkLogInOutButtonsVisible),
/* harmony export */   forgotPassword: () => (/* binding */ forgotPassword),
/* harmony export */   getAllTasks: () => (/* binding */ getAllTasks),
/* harmony export */   getAuthorName: () => (/* binding */ getAuthorName),
/* harmony export */   getAvatarSrc: () => (/* binding */ getAvatarSrc),
/* harmony export */   getIssuesCounterString: () => (/* binding */ getIssuesCounterString),
/* harmony export */   getTasksFullDetails: () => (/* binding */ getTasksFullDetails),
...
/* harmony export */   setToggleStatus: () => (/* binding */ setToggleStatus),
/* harmony export */   spotFixConfirmUserEmail: () => (/* binding */ spotFixConfirmUserEmail),
/* harmony export */   spotFixFormatDate: () => (/* binding */ spotFixFormatDate),
/* harmony export */   spotFixSplitUrl: () => (/* binding */ spotFixSplitUrl)
/* harmony export */ });
/* harmony import */ var _network_api__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../network/api */ "./src/network/api.js");
/* harmony import */ var _storage_localDB__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../storage/localDB */ "./src/storage/localDB.js");
...
/* harmony import */ var _main__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./main */ "./src/core/main.js");
/* harmony import */ var _network_websocket__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../network/websocket */ "./src/network/websocket.js");
/* harmony import */ var _loaders_SpotFixSVGLoader__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../loaders/SpotFixSVGLoader */ "./src/loaders/SpotFixSVGLoader.js");
...
async function spotFixConfirmUserEmail(emailConfirmationToken, params) {
  const result = await (0,_network_api__WEBPACK_IMPORTED_MODULE_0__.spotFixUserConfirmEmailDoboard)(emailConfirmationToken);
  ...
  await _storage_localDB__WEBPACK_IMPORTED_MODULE_1__.spotfixIndexedDB.init();
...
async function getTasksFullDetails(params, tasks, currentActiveTaskId, nonRequesting = false) {
  if (tasks.length > 0) {
    ...
    if (!nonRequesting) {
      await (0,_network_api__WEBPACK_IMPORTED_MODULE_0__.getTasksCommentsDoboard)(sessionId, params.accountId, params.projectToken);
    }
    const comments = await _storage_localDB__WEBPACK_IMPORTED_MODULE_1__.spotfixIndexedDB.getAll(_storage_localDB__WEBPACK_IMPORTED_MODULE_1__.SPOTFIX_TABLE_COMMENTS);
    if (!nonRequesting) {
      await (0,_network_api__WEBPACK_IMPORTED_MODULE_0__.getUserDoboard)(sessionId, params.projectToken, params.accountId);
    }
    const users = await _storage_localDB__WEBPACK_IMPORTED_MODULE_1__.spotfixIndexedDB.getAll(_storage_localDB__WEBPACK_IMPORTED_MODULE_1__.SPOTFIX_TABLE_USERS);
...
async function getUserDetails(params, nonRequesting = false) {
  ...
  if (currentUserId) {
    if (!nonRequesting) {
      await (0,_network_api__WEBPACK_IMPORTED_MODULE_0__.getUserDoboard)(sessionId, params.projectToken, params.accountId, currentUserId);
    }
    const users = await _storage_localDB__WEBPACK_IMPORTED_MODULE_1__.spotfixIndexedDB.getAll(_storage_localDB__WEBPACK_IMPORTED_MODULE_1__.SPOTFIX_TABLE_USERS);
...
async function handleCreateTask(sessionId, taskDetails) {
  try {
    const result = await (0,_network_api__WEBPACK_IMPORTED_MODULE_0__.createTaskDoboard)(sessionId, taskDetails);
...
async function addTaskComment(params, taskId, commentText) {
  ...
  return await (0,_network_api__WEBPACK_IMPORTED_MODULE_0__.createTaskCommentDoboard)(params.accountId, sessionId, taskId, commentText, params.projectToken);
}
async function getAllTasks(params, nonRequesting = false) {
  const projectToken = params.projectToken;
  const sessionId = localStorage.getItem('spotfix_session_id') || '';
  if (!nonRequesting) {
    await (0,_network_api__WEBPACK_IMPORTED_MODULE_0__.getTasksDoboard)(projectToken, sessionId, params.accountId, params.projectId);
  }
  const tasksData = await _storage_localDB__WEBPACK_IMPORTED_MODULE_1__.spotfixIndexedDB.getAll(_storage_localDB__WEBPACK_IMPORTED_MODULE_1__.SPOTFIX_TABLE_TASKS);
  (0,_storage_storage__WEBPACK_IMPORTED_MODULE_2__.storageSaveTasksCount)(tasksData);
...
function spotFixFormatDate(dateStr) {
...
function registerUser(taskDetails) {
  ...
  const resultRegisterUser = showMessageCallback => (0,_network_api__WEBPACK_IMPORTED_MODULE_0__.registerUserDoboard)(projectToken, accountId, userEmail, userName, pageURL).then(response => {
    if (response.accountExists) {
      document.querySelector('.doboard_task_widget-accordion>.doboard_task_widget-input-container').innerText = (0,_main__WEBPACK_IMPORTED_MODULE_3__.ksesFilter)('Account already exists. Please, login usin your password.');
      ...
      _storage_localDB__WEBPACK_IMPORTED_MODULE_1__.spotfixIndexedDB.init();
      ...
      submitButton.innerText = (0,_main__WEBPACK_IMPORTED_MODULE_3__.ksesFilter)('Create spot');
    } else {
...
function loginUser(taskDetails) {
  ...
  return showMessageCallback => (0,_network_api__WEBPACK_IMPORTED_MODULE_0__.loginUserDoboard)(userEmail, userPassword).then(response => {
...
function forgotPassword(userEmail) {
  return showMessageCallback => (0,_network_api__WEBPACK_IMPORTED_MODULE_0__.forgotPasswordDoboard)(userEmail).then(response => {
...
function userUpdate(projectToken, accountId) {
  ...
  return (0,_network_api__WEBPACK_IMPORTED_MODULE_0__.userUpdateDoboard)(projectToken, accountId, sessionId, userId, timezone);
}
...
function setToggleStatus(rootElement) {
  const clickHandler = () => {
    const timer = setTimeout(() => {
      ...
      _network_websocket__WEBPACK_IMPORTED_MODULE_4__.wsSpotfix.close();
      rootElement.hide();
      clearTimeout(timer);
    }, 300);
  };
...
async function clearUserMenuData() {
  ...
  if (avatarElement) {
    avatarElement.src = _loaders_SpotFixSVGLoader__WEBPACK_IMPORTED_MODULE_5__.SpotFixSVGLoader.getAsDataURI('iconAvatar');
  }
}
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   checkIfTasksHasSiteOwnerUpdates: () => (/* binding */ checkIfTasksHasSiteOwnerUpdates),
/* harmony export */   getAvatarData: () => (/* binding */ getAvatarData),
/* harmony export */   getTaskFullDetails: () => (/* binding */ getTaskFullDetails),
/* harmony export */   hideContainersSpinner: () => (/* binding */ hideContainersSpinner),
/* harmony export */   ksesFilter: () => (/* binding */ ksesFilter),
/* harmony export */   spotFixDebugLog: () => (/* binding */ spotFixDebugLog),
/* harmony export */   spotFixInit: () => (/* binding */ spotFixInit),
/* harmony export */   spotFixOpenWidget: () => (/* binding */ spotFixOpenWidget),
/* harmony export */   spotFixSelectionOpen: () => (/* binding */ spotFixSelectionOpen),
/* harmony export */   spotFixShowWidget: () => (/* binding */ spotFixShowWidget)
/* harmony export */ });
/* harmony import */ var _ui_widget__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../ui/widget */ "./src/ui/widget.js");
/* harmony import */ var _constants__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./constants */ "./src/core/constants.js");
/* harmony import */ var _storage_localDB__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../storage/localDB */ "./src/storage/localDB.js");
/* harmony import */ var _network_websocket__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../network/websocket */ "./src/network/websocket.js");
/* harmony import */ var _loaders_SpotFixSourcesLoader__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../loaders/SpotFixSourcesLoader */ "./src/loaders/SpotFixSourcesLoader.js");
/* harmony import */ var _styles_doboard_widget_css__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../styles/doboard-widget.css */ "./styles/doboard-widget.css");
/* harmony import */ var _utils_selections__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../utils/selections */ "./src/utils/selections.js");
/* harmony import */ var _handlers__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./handlers */ "./src/core/handlers.js");
/* harmony import */ var _storage_storage__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../storage/storage */ "./src/storage/storage.js");
...
function spotFixInit() {
  _storage_localDB__WEBPACK_IMPORTED_MODULE_2__.spotfixIndexedDB.init();
  _network_websocket__WEBPACK_IMPORTED_MODULE_3__.wsSpotfix.connect();
  _network_websocket__WEBPACK_IMPORTED_MODULE_3__.wsSpotfix.subscribe();
  new _loaders_SpotFixSourcesLoader__WEBPACK_IMPORTED_MODULE_4__.SpotFixSourcesLoader();
  new _ui_widget__WEBPACK_IMPORTED_MODULE_0__.CleanTalkWidgetDoboard({}, 'wrap');
  loadBotDetector();
  loadTinyMCE();
}
function spotFixSelectionOpen(event) {
  ...
  spotFixShowDelayTimeout = setTimeout(() => {
    ...
    if (selection.type === 'Range') {
      ...
      const selectedData = (0,_utils_selections__WEBPACK_IMPORTED_MODULE_6__.spotFixGetSelectedData)(selection);
      if (selectedData) {
        // spotFixOpenWidget(selectedData, 'create_issue');
        spotFixOpenWidget(selectedData, 'wrap_review');
      }
    }
  }, _constants__WEBPACK_IMPORTED_MODULE_1__.SPOTFIX_SELECTION_OPEN_DELAY);
}
...
function loadTinyMCE() {
  return new Promise(resolve => {
    ...
    script.onload = function () {
      ...
      (0,_handlers__WEBPACK_IMPORTED_MODULE_7__.addIconPack)();
    };
...
function spotFixShowWidget() {
  new _ui_widget__WEBPACK_IMPORTED_MODULE_0__.CleanTalkWidgetDoboard(null, 'create_issue');
}
...
function spotFixOpenWidget(selectedData, type) {
  if (selectedData) {
    new _ui_widget__WEBPACK_IMPORTED_MODULE_0__.CleanTalkWidgetDoboard(selectedData, type);
  }
}
...
function spotFixDebugLog(message) {
  if (_constants__WEBPACK_IMPORTED_MODULE_1__.SPOTFIX_DEBUG) {
    console.log(message);
  }
}
...
function getTaskFullDetails(tasksDetails, taskId) {
  ...
  let date = '',
    time = '';
  if (lastComment) {
    const dt = (0,_handlers__WEBPACK_IMPORTED_MODULE_7__.spotFixFormatDate)(lastComment.commentDate);
    date = dt.date;
    time = dt.time;
  }
  // Get the avatar and the name through separate functions
  let avatarSrc = (0,_handlers__WEBPACK_IMPORTED_MODULE_7__.getAvatarSrc)(author);
  let authorName = (0,_handlers__WEBPACK_IMPORTED_MODULE_7__.getAuthorName)(author);
  return {
    taskId: taskId,
    ...
    issueComments: comments.sort((a, b) => {
      return new Date(a.commentDate) - new Date(b.commentDate);
    }).map(comment => {
      const {
        date,
        time
      } = (0,_handlers__WEBPACK_IMPORTED_MODULE_7__.spotFixFormatDate)(comment.commentDate);
      let author = null;
      if (users && users.length > 0) {
        author = users.find(u => String(u.user_id) === String(comment.userId));
      }
      return {
        commentAuthorAvatarSrc: (0,_handlers__WEBPACK_IMPORTED_MODULE_7__.getAvatarSrc)(author),
        commentAuthorName: (0,_handlers__WEBPACK_IMPORTED_MODULE_7__.getAuthorName)(author),
...
function isAnyTaskUpdated(allTasksData) {
  ...
  for (let i = 0; i < allTasksData.length; i++) {
    ...
    if (currentStateOfTask.taskId && currentStateOfTask.taskLastUpdate && currentStateOfTask.taskCreatorTaskUser.toString() === issuerId.toString()) {
      result = (0,_storage_storage__WEBPACK_IMPORTED_MODULE_8__.storageCheckTaskUpdate)(currentStateOfTask.taskId, currentStateOfTask.taskLastUpdate);
      if (result) {
...
async function checkIfTasksHasSiteOwnerUpdates(allTasksData, params) {
  ...
  for (let i = 0; i < updatedTaskIDs.length; i++) {
    ...
    if (typeof updatedTaskId === 'string') {
      const updatedTaskData = await (0,_handlers__WEBPACK_IMPORTED_MODULE_7__.getTasksFullDetails)(params, [updatedTaskId]);
      if (updatedTaskData.comments) {
        const lastMessage = updatedTaskData.comments[0];
        if (lastMessage.commentUserId !== undefined && lastMessage.commentUserId !== localStorage.getItem('spotfix_user_id') && lastMessage.commentAuthorName !== 'Anonymous') {
          (0,_storage_storage__WEBPACK_IMPORTED_MODULE_8__.storageAddUnreadUpdateForTaskID)(updatedTaskId);
          result = true;
        }
      }
    }
  ...
  function clean(node) {
    if (node.nodeType === Node.ELEMENT_NODE) {
      ...
      [...node.attributes].forEach(attr => {
        ...
        if (!allowedAttrs[tag]?.includes(attrName) || attrName.startsWith('on') ||
...
/***/ "./src/loaders/SpotFixSVGLoader.js"
/*!*****************************************!*\
  !*** ./src/loaders/SpotFixSVGLoader.js ***!
  \*****************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   SpotFixSVGLoader: () => (/* binding */ SpotFixSVGLoader)
/* harmony export */ });
...
/***/ "./src/loaders/SpotFixSourcesLoader.js"
/*!*********************************************!*\
  !*** ./src/loaders/SpotFixSourcesLoader.js ***!
  \*********************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   SpotFixSourcesLoader: () => (/* binding */ SpotFixSourcesLoader)
/* harmony export */ });
...
/***/ "./src/loaders/SpotFixTemplatesLoader.js"
/*!***********************************************!*\
  !*** ./src/loaders/SpotFixTemplatesLoader.js ***!
  \***********************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   SpotFixTemplatesLoader: () => (/* binding */ SpotFixTemplatesLoader)
/* harmony export */ });
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   attachmentAddDoboard: () => (/* binding */ attachmentAddDoboard),
/* harmony export */   createTaskCommentDoboard: () => (/* binding */ createTaskCommentDoboard),
/* harmony export */   createTaskDoboard: () => (/* binding */ createTaskDoboard),
/* harmony export */   forgotPasswordDoboard: () => (/* binding */ forgotPasswordDoboard),
/* harmony export */   getReleaseVersion: () => (/* binding */ getReleaseVersion),
/* harmony export */   getTasksCommentsDoboard: () => (/* binding */ getTasksCommentsDoboard),
/* harmony export */   getTasksDoboard: () => (/* binding */ getTasksDoboard),
/* harmony export */   getUserDoboard: () => (/* binding */ getUserDoboard),
/* harmony export */   loginUserDoboard: () => (/* binding */ loginUserDoboard),
/* harmony export */   logoutUserDoboard: () => (/* binding */ logoutUserDoboard),
/* harmony export */   registerUserDoboard: () => (/* binding */ registerUserDoboard),
/* harmony export */   spotFixUserConfirmEmailDoboard: () => (/* binding */ spotFixUserConfirmEmailDoboard),
/* harmony export */   userUpdateDoboard: () => (/* binding */ userUpdateDoboard)
/* harmony export */ });
/* harmony import */ var _core_handlers__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../core/handlers */ "./src/core/handlers.js");
...
const spotfixApiCall = async (data, method, accountId = undefined) => {
  ...
  if (responseBody.data.operation_status === 'FAILED') {
    ...
    if (responseBody?.data?.operation_message === 'session_id Unknown') {
      (0,_storage_storage__WEBPACK_IMPORTED_MODULE_1__.clearLocalstorageOnLogout)();
      (0,_core_handlers__WEBPACK_IMPORTED_MODULE_0__.checkLogInOutButtonsVisible)();
    }
...
const getTasksDoboard = async (projectToken, sessionId, accountId, projectId, userId) => {
  ...
  await _storage_localDB__WEBPACK_IMPORTED_MODULE_2__.spotfixIndexedDB.clearPut(_storage_localDB__WEBPACK_IMPORTED_MODULE_2__.SPOTFIX_TABLE_TASKS, tasks);
  (0,_storage_storage__WEBPACK_IMPORTED_MODULE_1__.storageSaveTasksCount)(tasks);
  return tasks;
};
const getTasksCommentsDoboard = async (sessionId, accountId, projectToken, status = 'ACTIVE') => {
  ...
  await _storage_localDB__WEBPACK_IMPORTED_MODULE_2__.spotfixIndexedDB.clearPut(_storage_localDB__WEBPACK_IMPORTED_MODULE_2__.SPOTFIX_TABLE_COMMENTS, comments);
  return comments;
};
const getUserDoboard = async (sessionId, projectToken, accountId, userId) => {
  ...
  if (data.user_id) {
    await _storage_localDB__WEBPACK_IMPORTED_MODULE_2__.spotfixIndexedDB.put(_storage_localDB__WEBPACK_IMPORTED_MODULE_2__.SPOTFIX_TABLE_USERS, result.users);
  } else {
    await _storage_localDB__WEBPACK_IMPORTED_MODULE_2__.spotfixIndexedDB.clearPut(_storage_localDB__WEBPACK_IMPORTED_MODULE_2__.SPOTFIX_TABLE_USERS, result.users);
  }
  return result.users;
};
...
const getReleaseVersion = async () => {
  try {
    ...
    if (data.length > 0 && data[0].name) {
      (0,_storage_storage__WEBPACK_IMPORTED_MODULE_1__.storageSaveSpotfixVersion)(data[0].name);
      return data[0].name;
    } else {
      const res = await fetch('https://api.github.com/repos/CleanTalk/SpotFix/releases');
      data = await res.json();
      if (data.length > 0 && data[0].tag_name) {
        (0,_storage_storage__WEBPACK_IMPORTED_MODULE_1__.storageSaveSpotfixVersion)(data[0].tag_name);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   wsSpotfix: () => (/* binding */ wsSpotfix)
/* harmony export */ });
let socket = null;
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   SPOTFIX_TABLE_COMMENTS: () => (/* binding */ SPOTFIX_TABLE_COMMENTS),
/* harmony export */   SPOTFIX_TABLE_TASKS: () => (/* binding */ SPOTFIX_TABLE_TASKS),
/* harmony export */   SPOTFIX_TABLE_USERS: () => (/* binding */ SPOTFIX_TABLE_USERS),
/* harmony export */   spotfixIndexedDB: () => (/* binding */ spotfixIndexedDB)
/* harmony export */ });
...
const LOCAL_DATA_BASE_TABLE = [{
  name: SPOTFIX_TABLE_USERS,
  keyPath: 'user_id'
}, {
  name: SPOTFIX_TABLE_TASKS,
  keyPath: 'taskId'
}, {
  name: SPOTFIX_TABLE_COMMENTS,
  keyPath: 'commentId'
}];
...
function getDB() {
  if (!dbPromise) {
    ...
    dbPromise = openIndexedDB(getDBNameByKey(dbKey), spotfixIndexedDBVersion);
  }
  return dbPromise;
}
...
const spotfixIndexedDB = {
  ...
  getAll: async (table, indexName, value) => {
    return spotfixIndexedDB.withStore(table, 'readonly', store => {
      return new Promise((resolve, reject) => {
        const req = indexName && value !== undefined ? store.index(indexName).getAll(value) : store.getAll();
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   clearLocalstorageOnLogout: () => (/* binding */ clearLocalstorageOnLogout),
/* harmony export */   storageAddUnreadUpdateForTaskID: () => (/* binding */ storageAddUnreadUpdateForTaskID),
/* harmony export */   storageCheckTaskUpdate: () => (/* binding */ storageCheckTaskUpdate),
/* harmony export */   storageGetUserIsDefined: () => (/* binding */ storageGetUserIsDefined),
/* harmony export */   storageGetWidgetIsClosed: () => (/* binding */ storageGetWidgetIsClosed),
/* harmony export */   storageProvidedTaskHasUnreadUpdates: () => (/* binding */ storageProvidedTaskHasUnreadUpdates),
/* harmony export */   storageRemoveUnreadUpdateForTaskID: () => (/* binding */ storageRemoveUnreadUpdateForTaskID),
/* harmony export */   storageSaveSpotfixVersion: () => (/* binding */ storageSaveSpotfixVersion),
/* harmony export */   storageSaveTasksCount: () => (/* binding */ storageSaveTasksCount),
/* harmony export */   storageSaveTasksUpdateData: () => (/* binding */ storageSaveTasksUpdateData),
/* harmony export */   storageSetWidgetIsClosed: () => (/* binding */ storageSetWidgetIsClosed),
/* harmony export */   storageTasksHasUnreadUpdates: () => (/* binding */ storageTasksHasUnreadUpdates),
/* harmony export */   storageWidgetCloseIsSet: () => (/* binding */ storageWidgetCloseIsSet)
/* harmony export */ });
/* harmony import */ var _network_websocket__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../network/websocket */ "./src/network/websocket.js");
...
function storageSetWidgetIsClosed(visible) {
  ...
  if (visible) {
    _network_websocket__WEBPACK_IMPORTED_MODULE_0__.wsSpotfix.close();
  } else {
    _network_websocket__WEBPACK_IMPORTED_MODULE_0__.wsSpotfix.connect();
    _network_websocket__WEBPACK_IMPORTED_MODULE_0__.wsSpotfix.subscribe();
  }
}
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   CleanTalkWidgetDoboard: () => (/* binding */ CleanTalkWidgetDoboard)
/* harmony export */ });
/* harmony import */ var _loaders_SpotFixSVGLoader__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../loaders/SpotFixSVGLoader */ "./src/loaders/SpotFixSVGLoader.js");
/* harmony import */ var _utils_fileuploader__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../utils/fileuploader */ "./src/utils/fileuploader.js");
/* harmony import */ var _core_handlers__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../core/handlers */ "./src/core/handlers.js");
...
/* harmony import */ var _core_main__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../core/main */ "./src/core/main.js");
/* harmony import */ var _utils_selections__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../utils/selections */ "./src/utils/selections.js");
/* harmony import */ var _network_api__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../network/api */ "./src/network/api.js");
/* harmony import */ var _core_constants__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../core/constants */ "./src/core/constants.js");
/* harmony import */ var _storage_localDB__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../storage/localDB */ "./src/storage/localDB.js");
/* harmony import */ var _loaders_SpotFixTemplatesLoader__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../loaders/SpotFixTemplatesLoader */ "./src/loaders/SpotFixTemplatesLoader.js");
/* harmony import */ var _network_websocket__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../network/websocket */ "./src/network/websocket.js");
...
class CleanTalkWidgetDoboard {
  ...
  constructor(selectedData, type) {
    ...
    this.srcVariables = {
      buttonCloseScreen: _loaders_SpotFixSVGLoader__WEBPACK_IMPORTED_MODULE_0__.SpotFixSVGLoader.getAsDataURI('buttonCloseScreen'),
      iconEllipsesMore: _loaders_SpotFixSVGLoader__WEBPACK_IMPORTED_MODULE_0__.SpotFixSVGLoader.getAsDataURI('iconEllipsesMore'),
      iconPlus: _loaders_SpotFixSVGLoader__WEBPACK_IMPORTED_MODULE_0__.SpotFixSVGLoader.getAsDataURI('iconPlus'),
      iconMaximize: _loaders_SpotFixSVGLoader__WEBPACK_IMPORTED_MODULE_0__.SpotFixSVGLoader.getAsDataURI('iconMaximize'),
      chevronBack: _loaders_SpotFixSVGLoader__WEBPACK_IMPORTED_MODULE_0__.SpotFixSVGLoader.getAsDataURI('chevronBack'),
      buttonPaperClip: _loaders_SpotFixSVGLoader__WEBPACK_IMPORTED_MODULE_0__.SpotFixSVGLoader.getAsDataURI('buttonPaperClip'),
      buttonSendMessage: _loaders_SpotFixSVGLoader__WEBPACK_IMPORTED_MODULE_0__.SpotFixSVGLoader.getAsDataURI('buttonSendMessage'),
      logoDoBoardGreen: _loaders_SpotFixSVGLoader__WEBPACK_IMPORTED_MODULE_0__.SpotFixSVGLoader.getAsDataURI('logoDoBoardGreen'),
      logoDoBoardWrap: _loaders_SpotFixSVGLoader__WEBPACK_IMPORTED_MODULE_0__.SpotFixSVGLoader.getAsDataURI('logoDoBoardWrap'),
      iconSpotWidgetWrapPencil: _loaders_SpotFixSVGLoader__WEBPACK_IMPORTED_MODULE_0__.SpotFixSVGLoader.getAsDataURI('iconSpotWidgetWrapPencil'),
      iconMarker: _loaders_SpotFixSVGLoader__WEBPACK_IMPORTED_MODULE_0__.SpotFixSVGLoader.getAsDataURI('iconMarker'),
      iconSpotPublic: _loaders_SpotFixSVGLoader__WEBPACK_IMPORTED_MODULE_0__.SpotFixSVGLoader.getAsDataURI('iconSpotPublic'),
      iconSpotPrivate: _loaders_SpotFixSVGLoader__WEBPACK_IMPORTED_MODULE_0__.SpotFixSVGLoader.getAsDataURI('iconSpotPrivate'),
      iconLinkChain: _loaders_SpotFixSVGLoader__WEBPACK_IMPORTED_MODULE_0__.SpotFixSVGLoader.getAsDataURI('iconLinkChain')
    };
    this.fileUploader = new _utils_fileuploader__WEBPACK_IMPORTED_MODULE_1__.FileUploader(this.escapeHtml);
    this.init(type);
  }
  ...
  async init(type) {
    ...
    if (emailToken) {
      try {
        ...
        const createdTask = await (0,_core_handlers__WEBPACK_IMPORTED_MODULE_2__.spotFixConfirmUserEmail)(emailToken, this.params);
        this.allTasksData = await (0,_core_handlers__WEBPACK_IMPORTED_MODULE_2__.getAllTasks)(this.params, this.nonRequesting);
        // Open task interface
        this.currentActiveTaskId = createdTask.taskId;
        type = 'concrete_issue';
        (0,_storage_storage__WEBPACK_IMPORTED_MODULE_3__.storageSetWidgetIsClosed)(false);
    ...
    if ((0,_storage_storage__WEBPACK_IMPORTED_MODULE_3__.storageTasksHasUnreadUpdates)()) {
      taskHasSiteOwnerUpdate = true;
    } else {
      if (type === 'wrap_review') {
        taskHasSiteOwnerUpdate = await (0,_core_main__WEBPACK_IMPORTED_MODULE_4__.checkIfTasksHasSiteOwnerUpdates)(this.allTasksData, this.params);
      }
    }
    (0,_storage_storage__WEBPACK_IMPORTED_MODULE_3__.storageSaveTasksUpdateData)(this.allTasksData);
    //check to hide on first run
    if (!(0,_storage_storage__WEBPACK_IMPORTED_MODULE_3__.storageWidgetCloseIsSet)()) {
      (0,_storage_storage__WEBPACK_IMPORTED_MODULE_3__.storageSetWidgetIsClosed)(true);
    }
  ...
  bindCreateTaskEvents() {
    ...
    if (submitButton) {
      submitButton.addEventListener('click', async () => {
        ...
        const submitButton = document.getElementById('doboard_task_widget-submit_button');
        submitButton.disabled = true;
        submitButton.innerText = (0,_core_main__WEBPACK_IMPORTED_MODULE_4__.ksesFilter)('Creating spot...');
        let taskDetails = {
          taskTitle: taskTitle,
          ...
          taskMeta: JSON.stringify(this.selectedData ? this.selectedData : {
        ...
        (0,_storage_storage__WEBPACK_IMPORTED_MODULE_3__.storageSetWidgetIsClosed)(false);
        (0,_core_main__WEBPACK_IMPORTED_MODULE_4__.hideContainersSpinner)(false);
      });
    }
  }
  resetLoginForm() {
  ...
  bindShowLoginFormEvents() {
    ...
    if (loginButton) {
      loginButton.addEventListener('click', async () => {
        ...
        try {
          await (0,_core_handlers__WEBPACK_IMPORTED_MODULE_2__.loginUser)({
            userEmail: userEmail,
    ...
    if (restorePasswordButton) {
      restorePasswordButton.addEventListener('click', async () => {
        ...
        try {
          await (0,_core_handlers__WEBPACK_IMPORTED_MODULE_2__.forgotPassword)(userEmail)(this.registrationShowMessage);
        } catch (error) {
  ...
  async createWidgetElement(type, nonRequesting = false, showOnlyCurrentPage = false) {
    ...
    if (!nonRequesting) {
      widgetContainer.innerHTML = (0,_core_main__WEBPACK_IMPORTED_MODULE_4__.ksesFilter)('');
    }
    ...
    switch (type) {
      case 'create_issue':
        ...
        (0,_storage_storage__WEBPACK_IMPORTED_MODULE_3__.storageGetUserIsDefined)() && (0,_storage_storage__WEBPACK_IMPORTED_MODULE_3__.storageSetWidgetIsClosed)(false);
        break;
      case 'wrap':
        if ((0,_storage_storage__WEBPACK_IMPORTED_MODULE_3__.storageGetWidgetIsClosed)()) {
          return;
        }
        templateName = 'wrap';
        this.type_name = templateName;
        ...
        this.nonRequesting = nonRequesting;
        templateVariables = {
          position: !Number.isNaN(Number(config?.verticalPosition)) ? `${Number(config?.verticalPosition)}vh` : '0vh',
          ...this.srcVariables
        };
        break;
      case 'wrap_review':
      ...
      case 'user_menu':
        ...
        this.socket_type_name = templateName;
        this.nonRequesting = nonRequesting;
        const version = localStorage.getItem('spotfix_app_version') || _core_constants__WEBPACK_IMPORTED_MODULE_7__.SPOTFIX_VERSION;
        templateVariables = {
          spotfixVersion: version ? 'Spotfix version ' + version + '.' : '',
          avatar: _loaders_SpotFixSVGLoader__WEBPACK_IMPORTED_MODULE_0__.SpotFixSVGLoader.getAsDataURI('iconAvatar'),
          iconEye: _loaders_SpotFixSVGLoader__WEBPACK_IMPORTED_MODULE_0__.SpotFixSVGLoader.getAsDataURI('iconEye'),
          iconDoor: _loaders_SpotFixSVGLoader__WEBPACK_IMPORTED_MODULE_0__.SpotFixSVGLoader.getAsDataURI('iconDoor'),
          chevronBackDark: _loaders_SpotFixSVGLoader__WEBPACK_IMPORTED_MODULE_0__.SpotFixSVGLoader.getAsDataURI('chevronBackDark'),
          buttonCloseScreen: _loaders_SpotFixSVGLoader__WEBPACK_IMPORTED_MODULE_0__.SpotFixSVGLoader.getAsDataURI('buttonCloseScreen'),
          userName: 'Guest',
      ...
      case 'concrete_issue':
        ...
        this.savedIssuesQuantityOnPage = Array.isArray(this.allTasksData) ? this.allTasksData.filter(task => {
          try {
        ...
        templateVariables = {
          issueTitle: '...',
          issueComments: [],
          issuesCounter: (0,_core_handlers__WEBPACK_IMPORTED_MODULE_2__.getIssuesCounterString)(this.savedIssuesQuantityOnPage, this.savedIssuesQuantityAll),
          ...this.srcVariables
        };
        break;
      default:
    ...
    if (!nonRequesting) {
      ...
      (0,_utils_selections__WEBPACK_IMPORTED_MODULE_5__.spotFixRemoveHighlights)();
    }
    ...
    switch (type) {
      case 'create_issue':
        ...
        const descEl = document.querySelector('.doboard_task_widget-container-maximize #doboard_task_widget-description');
        if (descEl) {
        ...
        if (selection.type === 'Range') {
          const selectedData = (0,_utils_selections__WEBPACK_IMPORTED_MODULE_5__.spotFixGetSelectedData)(selection);
          if (selectedData) {
            (0,_utils_selections__WEBPACK_IMPORTED_MODULE_5__.spotFixScrollToNodePath)(selectedData.nodePath);
      ...
      case 'wrap_review':
        document.querySelector('#doboard_task_widget_button').addEventListener('click', e => {
          (0,_core_main__WEBPACK_IMPORTED_MODULE_4__.spotFixOpenWidget)(this.selectedData, 'create_issue');
        });
        break;
      case 'all_issues':
        if (this.nonRequesting) {
          (0,_core_main__WEBPACK_IMPORTED_MODULE_4__.hideContainersSpinner)();
        } else {
          (0,_core_handlers__WEBPACK_IMPORTED_MODULE_2__.changeSize)(container);
        }
        (0,_utils_selections__WEBPACK_IMPORTED_MODULE_5__.spotFixRemoveHighlights)();
        let issuesQuantityOnPage = 0;
        this.allTasksData = await (0,_core_handlers__WEBPACK_IMPORTED_MODULE_2__.getAllTasks)(this.params, this.nonRequesting);
        const tasks = this.allTasksData;
        tasksFullDetails = await (0,_core_handlers__WEBPACK_IMPORTED_MODULE_2__.getTasksFullDetails)(this.params, tasks, this.currentActiveTaskId, this.nonRequesting);
        ...
        if (tasks.length > 0) {
          ...
          for (let i = 0; i < sortedTasks.length; i++) {
            ...
            if (!showOnlyCurrentPage || currentPageURL === window.location.href) {
              const taskFullDetails = (0,_core_main__WEBPACK_IMPORTED_MODULE_4__.getTaskFullDetails)(tasksFullDetails, taskId);
              const avatarData = (0,_core_main__WEBPACK_IMPORTED_MODULE_4__.getAvatarData)(taskFullDetails);
              const listIssuesTemplateVariables = {
                ...
                taskLastMessage: (0,_core_main__WEBPACK_IMPORTED_MODULE_4__.ksesFilter)(taskFullDetails.lastMessageText),
                taskPageUrlFull: currentPageURL,
                iconLinkChain: this.srcVariables.iconLinkChain,
                taskFormattedPageUrl: (0,_core_handlers__WEBPACK_IMPORTED_MODULE_2__.spotFixSplitUrl)(currentPageURL),
                taskPageUrl: localStorage.getItem('maximize') === '1' ? currentPageURL : (0,_core_handlers__WEBPACK_IMPORTED_MODULE_2__.spotFixSplitUrl)(currentPageURL),
              ...
              const taskOwnerReplyIsUnread = (0,_storage_storage__WEBPACK_IMPORTED_MODULE_3__.storageProvidedTaskHasUnreadUpdates)(taskFullDetails.taskId);
          ...
          (0,_utils_selections__WEBPACK_IMPORTED_MODULE_5__.spotFixHighlightElements)(spotsToBeHighlighted, this);
          document.querySelector('.doboard_task_widget-header span').innerHTML = (0,_core_main__WEBPACK_IMPORTED_MODULE_4__.ksesFilter)('All spots ' + (0,_core_handlers__WEBPACK_IMPORTED_MODULE_2__.getIssuesCounterString)(this.savedIssuesQuantityOnPage, this.savedIssuesQuantityAll));
        }
        if (tasks.length === 0) {
          document.querySelector(".doboard_task_widget-all_issues-container").innerHTML = (0,_core_main__WEBPACK_IMPORTED_MODULE_4__.ksesFilter)('<div class="doboard_task_widget-issues_list_empty">The issues list is empty</div>');
        }
        ...
        break;
      case 'user_menu':
        (0,_core_handlers__WEBPACK_IMPORTED_MODULE_2__.setToggleStatus)(this);
        (0,_core_handlers__WEBPACK_IMPORTED_MODULE_2__.checkLogInOutButtonsVisible)();
        const user = await (0,_core_handlers__WEBPACK_IMPORTED_MODULE_2__.getUserDetails)(this.params, this.nonRequesting);
        if (!this.nonRequesting) await (0,_network_api__WEBPACK_IMPORTED_MODULE_6__.getReleaseVersion)();
        let spotfixVersion = '';
        const version = localStorage.getItem('spotfix_app_version') || _core_constants__WEBPACK_IMPORTED_MODULE_7__.SPOTFIX_VERSION;
        spotfixVersion = version ? `Spotfix version ${version}.` : '';
      ...
      case 'concrete_issue':
        if (this.nonRequesting) {
          (0,_core_main__WEBPACK_IMPORTED_MODULE_4__.hideContainersSpinner)();
          this.allTasksData = await _storage_localDB__WEBPACK_IMPORTED_MODULE_8__.spotfixIndexedDB.getAll(_storage_localDB__WEBPACK_IMPORTED_MODULE_8__.SPOTFIX_TABLE_TASKS);
        } else {
          (0,_core_handlers__WEBPACK_IMPORTED_MODULE_2__.changeSize)(container);
        }
        tasksFullDetails = await (0,_core_handlers__WEBPACK_IMPORTED_MODULE_2__.getTasksFullDetails)(this.params, this.allTasksData, this.currentActiveTaskId, this.nonRequesting);
        const taskDetails = await (0,_core_main__WEBPACK_IMPORTED_MODULE_4__.getTaskFullDetails)(tasksFullDetails, this.currentActiveTaskId, this.nonRequesting);
        // Update issue title in the interface
        const issueTitleElement = document.querySelector('.doboard_task_widget-issue-title');
        if (issueTitleElement) {
          issueTitleElement.innerText = (0,_core_main__WEBPACK_IMPORTED_MODULE_4__.ksesFilter)(tasksFullDetails.taskName || taskDetails?.issueTitle);
        }
        ...
        templateVariables.taskFormattedPageUrl = taskFormattedPageUrl.length < 2 ? meta.pageURL.replace(/^https?:\/\//, '') : taskFormattedPageUrl;
        ...
        templateVariables.contenerClasess = +localStorage.getItem('maximize') ? 'doboard_task_widget-container-maximize doboard_task_widget-container' : 'doboard_task_widget-container';
        if (this.nonRequesting) {
        ...
        if (meta && nodePath) {
          ...
          (0,_utils_selections__WEBPACK_IMPORTED_MODULE_5__.spotFixHighlightElements)([meta], this);
          if (typeof _utils_selections__WEBPACK_IMPORTED_MODULE_5__.spotFixScrollToNodePath === 'function') {
            (0,_utils_selections__WEBPACK_IMPORTED_MODULE_5__.spotFixScrollToNodePath)(nodePath);
          }
        }
        ...
        if (taskDetails.issueComments.length > 0) {
          (0,_storage_storage__WEBPACK_IMPORTED_MODULE_3__.storageRemoveUnreadUpdateForTaskID)(taskDetails.taskId);
          issuesCommentsContainer.innerHTML = (0,_core_main__WEBPACK_IMPORTED_MODULE_4__.ksesFilter)('');
          for (const comment of taskDetails.issueComments) {
            userIsIssuer = Number(initIssuerID) === Number(comment.commentUserId);
            const avatarData = (0,_core_main__WEBPACK_IMPORTED_MODULE_4__.getAvatarData)({
          ...
          issuesCommentsContainer.innerHTML = (0,_core_main__WEBPACK_IMPORTED_MODULE_4__.ksesFilter)('No comments');
        }
        ...
        if (sendButton) {
          ...
          const clickHandler = async e => {
            ...
            try {
              newCommentResponse = await (0,_core_handlers__WEBPACK_IMPORTED_MODULE_2__.addTaskComment)(this.params, this.currentActiveTaskId, commentText);
              input.value = '';
    ...
    document.querySelector('#doboard_task_widget-user_menu-logout_button')?.addEventListener('click', () => {
      (0,_network_api__WEBPACK_IMPORTED_MODULE_6__.logoutUserDoboard)(this.params.projectToken);
    }) || '';
    document.getElementById('addNewTaskButton')?.addEventListener('click', () => {
      (0,_core_main__WEBPACK_IMPORTED_MODULE_4__.spotFixShowWidget)();
    }) || '';
    document.getElementById('maximizeWidgetContainer')?.addEventListener('click', () => {
      const container = document.querySelector('.doboard_task_widget-container');
      const isMaximized = +localStorage.getItem('maximize') && container.classList.contains('doboard_task_widget-container-maximize');
      if (isMaximized) {
        localStorage.setItem('maximize', '0');
        container.classList.remove('doboard_task_widget-container-maximize');
        if (this.type_name === 'all_issues') {
          document.querySelectorAll('.spotfix_widget_task_url-full').forEach(el => el.style.display = 'none');
          document.querySelectorAll('.spotfix_widget_task_url').forEach(el => el.style.display = 'none');
          document.querySelectorAll('.spotfix_widget_task_url-short').forEach(el => el.style.display = 'inline');
        }
      } else {
        localStorage.setItem('maximize', '1');
        container.classList.add('doboard_task_widget-container-maximize');
        if (this.type_name === 'all_issues') {
          document.querySelectorAll('.spotfix_widget_task_url-full').forEach(el => el.style.display = 'inline');
          document.querySelectorAll('.spotfix_widget_task_url-short').forEach(el => el.style.display = 'none');
          document.querySelectorAll('.spotfix_widget_task_url').forEach(el => el.style.display = 'none');
        }
      }
    });
    ...
    _network_websocket__WEBPACK_IMPORTED_MODULE_10__.wsSpotfix.onMessage(() => {
  ...
  async showOneTask() {
    ...
    if (taskHighlightData) {
      (0,_utils_selections__WEBPACK_IMPORTED_MODULE_5__.spotFixRemoveHighlights)();
      (0,_utils_selections__WEBPACK_IMPORTED_MODULE_5__.spotFixHighlightElements)([taskHighlightData], this);
      this.positionWidgetContainer();
    }
    (0,_core_main__WEBPACK_IMPORTED_MODULE_4__.hideContainersSpinner)(false);
  }
  ...
  loadTemplate(templateName, variables = {}) {
    let template = _loaders_SpotFixTemplatesLoader__WEBPACK_IMPORTED_MODULE_9__.SpotFixTemplatesLoader.getTemplateCode(templateName);
    for (const [key, value] of Object.entries(variables)) {
      ...
      if (this.isPlaceholderInAttribute(template, placeholder)) {
        ...
        replacement = (0,_core_main__WEBPACK_IMPORTED_MODULE_4__.ksesFilter)(String(value), {
    ...
    return (0,_core_main__WEBPACK_IMPORTED_MODULE_4__.ksesFilter)(template, {
      template: templateName
    });
  }
  ...
  isPlaceholderInAttribute(template, placeholder) {
    ...
    const attributePattern = new RegExp(`[\\w-]+\\s*=\\s*["'][^"']*${escapedPlaceholder}[^"']*["']`, 'g');
  ...
  async getTaskCount() {
    ...
    if (tasksCountLS === undefined) {
      if (!this.nonRequesting) {
        await (0,_network_api__WEBPACK_IMPORTED_MODULE_6__.getTasksDoboard)(projectToken, sessionId, this.params.accountId, this.params.projectId);
      }
      const tasks = await _storage_localDB__WEBPACK_IMPORTED_MODULE_8__.spotfixIndexedDB.getAll(_storage_localDB__WEBPACK_IMPORTED_MODULE_8__.SPOTFIX_TABLE_TASKS);
      (0,_storage_storage__WEBPACK_IMPORTED_MODULE_3__.storageSaveTasksCount)(tasks);
    ...
    if (taskCountElement) {
      taskCountElement.innerText = (0,_core_main__WEBPACK_IMPORTED_MODULE_4__.ksesFilter)(tasksCount);
  ...
  async submitTask(taskDetails) {
    if (!localStorage.getItem('spotfix_session_id')) {
      await (0,_core_handlers__WEBPACK_IMPORTED_MODULE_2__.registerUser)(taskDetails)(this.registrationShowMessage);
      if (taskDetails.userPassword) {
        await (0,_core_handlers__WEBPACK_IMPORTED_MODULE_2__.loginUser)(taskDetails)(this.registrationShowMessage);
        (0,_core_handlers__WEBPACK_IMPORTED_MODULE_2__.checkLogInOutButtonsVisible)();
      }
    }
    const sessionId = localStorage.getItem('spotfix_session_id');
    ...
    return await (0,_core_handlers__WEBPACK_IMPORTED_MODULE_2__.handleCreateTask)(sessionId, taskDetails);
  }
  ...
  registrationShowMessage(messageText, type = 'error') {
    ...
    if (typeof messageText === 'string' && messageDiv !== null && messageWrap !== null) {
      messageDiv.innerText = (0,_core_main__WEBPACK_IMPORTED_MODULE_4__.ksesFilter)(messageText);
      ...
      if (type === 'notice') {
        titleSpan.innerText = (0,_core_main__WEBPACK_IMPORTED_MODULE_4__.ksesFilter)('');
        messageWrap.classList.add('doboard_task_widget-notice_message');
        messageDiv.style.color = '#2a5db0';
      } else {
        titleSpan.innerText = (0,_core_main__WEBPACK_IMPORTED_MODULE_4__.ksesFilter)('Registration error');
  ...
  async setUserMenuData() {
    ...
    if (localStorage.getItem('spotfix_session_id')) {
      try {
        userData = await (0,_core_handlers__WEBPACK_IMPORTED_MODULE_2__.getUserDetails)(params);
      } catch (error) {
...
/* harmony export */ });
/* harmony import */ var _network_api__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../network/api */ "./src/network/api.js");
/* harmony import */ var _core_main__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../core/main */ "./src/core/main.js");
...
class FileUploader {
  ...
  renderFileList() {
    ...
    if (this.files.length === 0) {
      this.fileList.innerHTML = (0,_core_main__WEBPACK_IMPORTED_MODULE_1__.ksesFilter)('<div style="text-align: center; color: #444c529e;">No files attached</div>');
      return;
    }
    const fileItems = this.files.map(fileData => this.createFileItem(fileData));
    this.fileList.innerHTML = (0,_core_main__WEBPACK_IMPORTED_MODULE_1__.ksesFilter)('');
  ...
  createFileItem(fileData) {
    ...
    fileItem.innerHTML = (0,_core_main__WEBPACK_IMPORTED_MODULE_1__.ksesFilter)(`
  ...
  validateFileData(fileData) {
    const validations = [{
      ...
      field: 'params.accountId',
      type: 'string',
      message: 'No valid account ID found.'
    }, {
      field: 'params.projectToken',
      type: 'string',
      message: 'No valid project token found.'
    }, {
      field: 'commentId',
      type: 'string',
      message: 'No valid commentId found.'
    }, {
      field: 'fileName',
      type: 'string',
  ...
  async sendSingleAttachment(fileData) {
    ...
    return await (0,_network_api__WEBPACK_IMPORTED_MODULE_0__.attachmentAddDoboard)(validatedFileData);
  }
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   spotFixGetSelectedData: () => (/* binding */ spotFixGetSelectedData),
/* harmony export */   spotFixHighlightElements: () => (/* binding */ spotFixHighlightElements),
/* harmony export */   spotFixRemoveHighlights: () => (/* binding */ spotFixRemoveHighlights),
/* harmony export */   spotFixScrollToNodePath: () => (/* binding */ spotFixScrollToNodePath)
/* harmony export */ });
...
function spotFixGetSelectionType(selection) {
  ...
  if (commonAncestor.nodeType === Node.ELEMENT_NODE && commonAncestor.childNodes.length > 1 && range.toString().trim() === '' && range.startContainer === range.endContainer && range.startContainer.nodeType === Node.ELEMENT_NODE) {
...
function spotFixGetSelectedData(selection) {
  ...
  if (!selection) {
    (0,_core_main__WEBPACK_IMPORTED_MODULE_0__.spotFixDebugLog)('`spotFixGetSelectedData` skip by `Selection not provided`');
    return null;
  }
  // Range not provided
  if (selection.rangeCount === 0) {
    (0,_core_main__WEBPACK_IMPORTED_MODULE_0__.spotFixDebugLog)('`spotFixGetSelectedData` skip by `Range not provided`');
    return null;
  }
  // Several ranges provided
  if (selection.rangeCount > 1) {
    (0,_core_main__WEBPACK_IMPORTED_MODULE_0__.spotFixDebugLog)('`spotFixGetSelectedData` skip by `Several ranges provided`');
    return null;
  }
  const range = selection.getRangeAt(0);
  // Selection must be within a single DOM element.
  if (range.startContainer !== range.endContainer) {
    (0,_core_main__WEBPACK_IMPORTED_MODULE_0__.spotFixDebugLog)('`spotFixGetSelectedData` skip by `Selection within several tags nodes`');
    return null;
  }
  ...
  if (!selectionType) {
    (0,_core_main__WEBPACK_IMPORTED_MODULE_0__.spotFixDebugLog)('`spotFixGetSelectedData` skip by `Selection type not determined`');
    return null;
  }
  ...
  switch (selectionType) {
    case SPOTFIX_SELECTION_TYPE_TEXT:
      if (range.toString().trim().length === 0) {
        (0,_core_main__WEBPACK_IMPORTED_MODULE_0__.spotFixDebugLog)('`spotFixGetSelectedData` skip by `Selection text is empty`');
        return null;
      }
    ...
    case SPOTFIX_SELECTION_TYPE_ELEMENT:
      ...
      if (element.childNodes.length <= 1) {
        (0,_core_main__WEBPACK_IMPORTED_MODULE_0__.spotFixDebugLog)('`spotFixGetSelectedData` skip by `Selection have not inner data`');
        return null;
      }
...
function spotFixHighlightElements(spotsToBeHighlighted, widgetInstance) {
  ...
  spotsToBeHighlighted.forEach(spot => {
    ...
    if (!spot?.nodePath || !Array.isArray(spot?.nodePath)) {
      (0,_core_main__WEBPACK_IMPORTED_MODULE_0__.spotFixDebugLog)('Invalid spot: missing or invalid nodePath: ' + spot);
      return;
    }

    // nodePath validating: is valid indexes list
    if (!spotFixIsValidNodePath(spot.nodePath)) {
      (0,_core_main__WEBPACK_IMPORTED_MODULE_0__.spotFixDebugLog)('Invalid nodePath format: ' + spot.nodePath);
      return;
    }
    const element = spotFixRetrieveNodeFromPath(spot.nodePath);
    if (!element) {
      (0,_core_main__WEBPACK_IMPORTED_MODULE_0__.spotFixDebugLog)('Element not found for path: ' + spot.nodePath);
      return;
    }
    if (!spot.selectionType) {
      ...
      (0,_core_main__WEBPACK_IMPORTED_MODULE_0__.spotFixDebugLog)('Selection type is not provided.');
      return;
    }

    // selectionType parameter validating
    if (spot.selectionType && ![SPOTFIX_SELECTION_TYPE_TEXT, SPOTFIX_SELECTION_TYPE_IMG, SPOTFIX_SELECTION_TYPE_ELEMENT].includes(spot.selectionType)) {
      (0,_core_main__WEBPACK_IMPORTED_MODULE_0__.spotFixDebugLog)('Invalid selection type: ' + spot.selectionType);
      return;
    }
  ...
  elementsMap.forEach((spots, element) => {
    ...
    switch (selectionType) {
      ...
      case 'text':
        ...
        break;
      default:
        (0,_core_main__WEBPACK_IMPORTED_MODULE_0__.spotFixDebugLog)('Unknown selection type: ' + selectionType);
    }
  });
}
...
function spotFixHighlightImageElement(element) {
  if (element.tagName !== 'IMG') {
    (0,_core_main__WEBPACK_IMPORTED_MODULE_0__.spotFixDebugLog)('Expected IMG element for image highlight, got: ' + element.tagName);
    return;
  }
...
function spotFixHighlightTextInElement(element, spots, widgetInstance) {
  ...
  if (!spotSelectedText) {
    (0,_core_main__WEBPACK_IMPORTED_MODULE_0__.spotFixDebugLog)('Provided metadata is invalid.');
    return;
  }
  const markers = [];
  ...
  spots.forEach(spot => {
    ...
    if (startPos < 0 || endPos > text.length || startPos > endPos) {
      (0,_core_main__WEBPACK_IMPORTED_MODULE_0__.spotFixDebugLog)('Invalid text positions: ' + spot);
      return;
    }
    markers.push({
      position: startPos,
  ...
  if (text.slice(markers[1].position, markers[0].position) !== spotSelectedText) {
    (0,_core_main__WEBPACK_IMPORTED_MODULE_0__.spotFixDebugLog)('It is not allow to highlight element by provided metadata.');
    return;
  }
  let result = text;
  markers.forEach(marker => {
    const insertText = marker.type === 'start' ? spotfixHighlightOpen : spotfixHighlightClose;
    result = result.slice(0, marker.position) + insertText + result.slice(marker.position);
  });

  // Safety HTML insert
  try {
    element.innerHTML = (0,_core_main__WEBPACK_IMPORTED_MODULE_0__.ksesFilter)(result);
    ...
    (0,_core_main__WEBPACK_IMPORTED_MODULE_0__.spotFixDebugLog)('Error updating element content: ' + error);
  }
}
...
function spotFixGetSelectedImage(selection) {
  ...
  if (range.startContainer === range.endContainer && range.startContainer.nodeType === Node.ELEMENT_NODE && range.startContainer.tagName === 'IMG') {
  ...
  const walker = document.createTreeWalker(range.commonAncestorContainer, NodeFilter.SHOW_ELEMENT, {
    acceptNode: function (node) {
      return node.tagName === 'IMG' && spotFixIsElementInRange(node, range) ? NodeFilter.FILTER_ACCEPT : NodeFilter.FILTER_REJECT;
    }
  });
  ...
  if (startElement && startElement.tagName === 'IMG' && spotFixIsElementPartiallySelected(startElement, range)) {
    return startElement;
  }
  if (endElement && endElement.tagName === 'IMG' && spotFixIsElementPartiallySelected(endElement, range)) {
    return endElement;
  }
...
function spotFixIsElementInRange(element, range) {
  ...
  return range.compareBoundaryPoints(Range.START_TO_START, elementRange) <= 0 && range.compareBoundaryPoints(Range.END_TO_END, elementRange) >= 0;
}
function spotFixIsElementPartiallySelected(element, range) {
  ...
  return !(elementRect.right < rangeRect.left || elementRect.left > rangeRect.right || elementRect.bottom < rangeRect.top || elementRect.top > rangeRect.bottom);
}
...
/***/ "./node_modules/css-loader/dist/cjs.js!./styles/doboard-widget.css"
/*!*************************************************************************!*\
  !*** ./node_modules/css-loader/dist/cjs.js!./styles/doboard-widget.css ***!
  \*************************************************************************/
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, `.doboard_task_widget-send_message_paperclip .doboard_task_widget-paperclip-tooltip::after {
    content: "";
    position: absolute;
    left: 8%;
    top: 100%;
...
.doboard_task_widget-send_message_paperclip .doboard_task_widget-paperclip-tooltip::after {
    border-left: 8px solid transparent;
    border-right: 8px solid transparent;
    border-top: 8px solid #545b61;
    display: block;
}
...
.doboard_task_widget-send_message_paperclip .doboard_task_widget-paperclip-tooltip {
    display: none;
    position: absolute;
    left: 0;
    bottom: 0;
    transform: translateX(-3%) translateY(-43px);
    background: #545b61;
    color: #FFF;
    border: none;
    border-radius: 3px;
...
.doboard_task_widget-send_message_paperclip:hover .doboard_task_widget-paperclip-tooltip {
    display: block;
}
/** COMMON CLASSES **/
...
.doboard_task_widget-header-icons {
    display: flex;
}
...
.doboard_task_widget-user_menu-header {
    display: flex;
    padding: 16px 16px;
    border: 1px #BBC7D1 solid;
...
.doboard_task_widget-user_menu-header-top {
    display: flex;
    height: fit-content;
    align-items: center;
    width: 100%;
...
.doboard_task_widget-user_menu-header-avatar {
    max-width: 60px;
    max-height: 60px;
    width: 60px;
    height: 60px;
...
.doboard_task_widget-user_menu-item {
    display: flex;
    align-items: center;
...
.doboard_task_widget-message-wrapper.hidden {
    display: none;
}
...
.doboard_task_widget-text_selection.image-highlight > img,
.doboard_task_widget-element_selection,
.doboard_task_widget-image_selection {
...
.doboard_task_widget-all_issues {
   padding-bottom: 0;
}
...
.doboard_task_widget-task_page_url {
    max-width: 70%;
    height: 36px;
    display: flex;
    align-items: center;
...
.doboard_task_widget-task_page_url a {
    color: #40484F;
    text-decoration: none;
    margin-left: 8px;
    white-space: nowrap;
...
.doboard_task_widget-bottom {
    display: flex;
    justify-content: space-between;
}

.doboard_task_widget-bottom-is-fixed {
    border-radius: 10px;
    background-size: 14px 14px;
    background: #EBFAF4 url(${___CSS_LOADER_URL_REPLACEMENT_0___}) no-repeat 8px center;
    padding: 4px 7px 4px 30px;
}

.doboard_task_widget-bottom-is-fixed-task-block {
    text-align: center;
}
.doboard_task_widget-bottom-is-fixed-task {
    background: #F3F6F9;
    color: #1C7857;
    display: inline-block;
    border-radius: 10px;
...
.doboard_task_widget-task_row-green {
    background: #EBF0F4;
}
...
.doboard_task_widget-comment_text_container:after {
    content: "";
    position: absolute;
    bottom: 0;
    left: -5px;
...
.doboard_task_widget-comment_data_owner .doboard_task_widget-comment_text_container {
    background: #EBFAF4;
}
...
.doboard_task_widget-comment_body strong {
    font-variation-settings: "wght" 700;
}

.doboard_task_widget-comment_body blockquote {
    margin: 0;
    border-left: 3px solid #22a475;
}

.doboard_task_widget-comment_body blockquote p {
    margin: 0 10px;
}

.doboard_task_widget-comment_body details .mce-accordion-body {
    padding-left: 20px;
}

.doboard_task_widget-comment_body details .mce-accordion-summary {
    background: url(${___CSS_LOADER_URL_REPLACEMENT_3___}) no-repeat 0;
    padding-left: 20px;
}

.doboard_task_widget-comment_body .mce-accordion[open] .mce-accordion-summary {
    background: url(${___CSS_LOADER_URL_REPLACEMENT_4___}) no-repeat 0;
}

.doboard_task_widget-comment_body details .mce-accordion-summary::marker {
    content: "";
}

.doboard_task_widget-comment_body pre {
...
.doboard_task_widget-comment_body-img-strict {
    max-width: -webkit-fill-available;
    height: 100px;
    margin-right: 5px;
}
...
.doboard_task_widget-send_message_input_wrapper textarea {
    position: relative;
    width: 100%;
    height: 37px;
    border: none;
...
.doboard_task_widget-send_message_input_wrapper textarea.high {
    height: 170px;
}

.doboard_task_widget-send_message_input_wrapper textarea:focus {
    background: #F3F6F9;
    border-color: #007bff;
    outline: none;
}
...
.doboard_task_widget-create_issue {
    padding: 10px;
}

/*fileuplaod*/

.doboard_task_widget__file-upload__wrapper {
    display: none;
    border: 1px solid #BBC7D1;
    margin-top: 14px;
    padding: 0 10px 10px;
...
.doboard_task_widget__file-upload__list-header {
    text-align: left;
    font-size: .9em;
    margin: 5px 0;
    color: #444c529e;
...
.doboard_task_widget__file-upload__file-input-button {
    display: none;
}

.doboard_task_widget__file-upload__file-list {
...
.doboard_task_widget__file-upload__file-item {
    display: flex;
    justify-content: space-between;
    align-items: center;
    padding: 4px;
    border-bottom: 1px solid #bbc7d16b;
}

.doboard_task_widget__file-upload__file-item:last-child {
    border-bottom: none;
}

.doboard_task_widget__file-upload__file_info {
    display: inline-flex;
    align-items: center;
}

.doboard_task_widget__file-upload__file-name {
    font-weight: bold;
    font-size: 0.9em;
}

.doboard_task_widget__file-upload__file-item-content {
    width: 100%;
}

.doboard_task_widget__file-upload__file_size {
    color: #666;
    font-size: 0.8em;
    margin-left: 6px;
}

.doboard_task_widget__file-upload__remove-btn {
    background: #22a475;
    color: white;
    border: none;
    border-radius: 3px;
...
.doboard_task_widget__file-upload__error {
    display: block;
    margin: 7px 0 0;
    padding: 7px;
    border-radius: 4px;
...
.doboard_task_widget-show_button {
    position: fixed;
    background: #1C7857;
    color: #FFFFFF;
    padding: 8px 12px;
...
.doboard_task_widget_tasks_list {
    background-color: white;
    position: sticky;
    bottom: 0px;
    height: 38px;
...
#doboard_task_widget-user_menu-logout_button {
    display: inline-flex;
    align-items: center;
}
...
.doboard_task_widget-see-task {
    cursor: pointer;
    text-decoration: underline;
}

.doboard_task_widget-text_selection_tooltip {
    position: absolute;
    bottom: 100%;
    left: 50%;
    transform: translateX(-50%);
    ...
    z-index: 9000;
    border: 1px solid #BBC7D1;
    margin-bottom: 8px; /* Отступ от элемента */
}

.doboard_task_widget-text_selection_tooltip::after {
    content: '';
    position: absolute;
    top: 100%;
    left: 50%;
    ...
    border-top-color: #FFFFFF; /* Цвет фона подсказки */
}

.doboard_task_widget-text_selection_tooltip::before {
    content: '';
    position: absolute;
    top: 100%;
    left: 50%;
    ...
    border-top-color: #BBC7D1; /* Цвет границы подсказки */
    z-index: -1;
}

.doboard_task_widget-text_selection_tooltip_icon {
...
.doboard_task_widget-text_selection_tooltip_element {
    display: flex;
    justify-content: space-between;
}
...
.doboard_task_widget-bottom-eye-icon {
    ...
    width: 20px;
    height: 20px;
    background: #fff url(${___CSS_LOADER_URL_REPLACEMENT_6___}) no-repeat center center;
...
.doboard_task_widget-bottom-eye-off-icon {
    ...
    width: 20px;
    height: 20px;
    background: #fff url(${___CSS_LOADER_URL_REPLACEMENT_7___}) no-repeat center center;
    background-size: 16px 16px;
    cursor: pointer;
    border-radius: 50%;
    transition: all 0.2s ease;
...
/* harmony import */ var _node_modules_css_loader_dist_cjs_js_doboard_widget_css__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! !!../node_modules/css-loader/dist/cjs.js!./doboard-widget.css */ "./node_modules/css-loader/dist/cjs.js!./styles/doboard-widget.css");
...
var update = _node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default()(_node_modules_css_loader_dist_cjs_js_doboard_widget_css__WEBPACK_IMPORTED_MODULE_6__["default"], options);




       /* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (_node_modules_css_loader_dist_cjs_js_doboard_widget_css__WEBPACK_IMPORTED_MODULE_6__["default"] && _node_modules_css_loader_dist_cjs_js_doboard_widget_css__WEBPACK_IMPORTED_MODULE_6__["default"].locals ? _node_modules_css_loader_dist_cjs_js_doboard_widget_css__WEBPACK_IMPORTED_MODULE_6__["default"].locals : undefined);
...
/***/ "data:image/svg+xml;charset=utf-8,%3Csvg transform=%27rotate%28180 0 0%29%27 xmlns=%27http://www.w3.org/2000/svg%27 viewBox=%270 0 20 20%27 style=%27enable-background:new 0 0 20 20%27 xml:space=%27preserve%27%3E%3Cpath d=%27M10 13.3c-.2 0-.4-.1-.6-.2l-5-5c-.3-.3-.3-.9 0-1.2.3-.3.9-.3 1.2 0l4.4 4.4 4.4-4.4c.3-.3.9-.3 1.2 0 .3.3.3.9 0 1.2l-5 5c-.2.2-.4.2-.6.2z%27/%3E%3C/svg%3E"
/*!************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** data:image/svg+xml;charset=utf-8,%3Csvg transform=%27rotate%28180 0 0%29%27 xmlns=%27http://www.w3.org/2000/svg%27 viewBox=%270 0 20 20%27 style=%27enable-background:new 0 0 20 20%27 xml:space=%27preserve%27%3E%3Cpath d=%27M10 13.3c-.2 0-.4-.1-.6-.2l-5-5c-.3-.3-.3-.9 0-1.2.3-.3.9-.3 1.2 0l4.4 4.4 4.4-4.4c.3-.3.9-.3 1.2 0 .3.3.3.9 0 1.2l-5 5c-.2.2-.4.2-.6.2z%27/%3E%3C/svg%3E ***!
  \************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
(module) {
...
/*!**********************!*\
  ...
  \**********************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _core_main_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./core/main.js */ "./src/core/main.js");

if (document.readyState !== 'loading') {
  document.addEventListener('spotFixLoaded', _core_main_js__WEBPACK_IMPORTED_MODULE_0__.spotFixInit);
} else {
  document.addEventListener('DOMContentLoaded', _core_main_js__WEBPACK_IMPORTED_MODULE_0__.spotFixInit);
}
document.addEventListener('selectionchange', function (e) {
  (0,_core_main_js__WEBPACK_IMPORTED_MODULE_0__.spotFixSelectionOpen)(e);
});
})();
