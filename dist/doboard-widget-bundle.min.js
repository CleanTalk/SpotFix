...
</div>`}}class SpotFixSVGLoader{static loadSVG(e){var t=this[e];if("function"!=typeof t)throw new Error(`Template method '${e}' not found`);return t.call(this).trim()}static getAsRawSVG(e){return this.loadSVG(e)}static getAsDataURI(e){e=this.loadSVG(e);return this.svgToDataURI(e)}static svgToDataURI(e){e=(new TextEncoder).encode(e);return"data:image/svg+xml;base64,"+btoa(String.fromCharCode(...e))}static chevronBack(){return`
...
</svg>`}static iconSpotWidgetWrap(){return`
<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
